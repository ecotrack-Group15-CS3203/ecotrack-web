...
/** Unclaimed reports waiting in the shared pool (an inbox tray). */
export const IconIncidentPool = (p: IconProps) => (
  <Icon
    {...p}
...
/** Pending requests to join the organisation (a person with a plus). */
export const IconJoinRequests = (p: IconProps) => (
  <Icon {...p} d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M8.5 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM20 8v6M23 11h-6" />
);
...
export const IconSun = (p: IconProps) => (
  <Icon
    {...p}
    d="M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41"
  />
);
